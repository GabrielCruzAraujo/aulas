<?php  
	...
	$execute_sql_cursos = $funcoes->listarJoinOratoria();
...
<body>
	...
	<div class="container text-center">
		<h1 class="py-4 bg-dark text-light rounded"><i class="fas fa-swatchbook"></i> Curso de Oratória</h1>
		...
		<div class="d-flex table-data">
				...
				<tr>
					...
					<td><?php echo $dado["comprovante"]; ?></td>
